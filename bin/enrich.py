...
# Define utility functions that work in all environments
def make_api_request(
    ...
    """Make API request - dummy implementation that works in all environments."""
...
try:
    ...
    from utils.io import make_api_request as real_make_api_request
    ...
    # Replace our utility functions with the real ones
    make_api_request = real_make_api_request
