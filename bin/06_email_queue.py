...
EMAIL_TEMPLATE_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "etc", "email_template.html")
...
def main():
    ...
    parser.add_argument("--force", action="store_true", help="Force sending emails even if they've been sent before")
