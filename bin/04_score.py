...
RULES_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "etc", "scoring_rules.yml")
...
class RuleEngine:
    ...
    def load_rules(self):
        ...
        try:
            ...
            logger.info(f"Loaded {len(self.rules)} rules and {len(self.multipliers)} multipliers from {self.rules_file}")
...
def main():
    ...
    parser.add_argument("--recalculate", action="store_true", help="Recalculate scores for businesses that already have scores")
