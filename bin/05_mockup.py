...
class GPT4oMockupGenerator:
    ...
    def generate_mockup(
        ...
        payload = {
            "model": self.model,
            "messages": [
                {"role": "system", "content": "You are a professional web designer specializing in creating modern, conversion-focused websites for small businesses. Your task is to generate a mockup image and corresponding HTML/CSS for a business website based on the provided information."},
    ...
    def generate_mockup(
        ...
        try:
            ...
            if html_match:
                ...
                return None, mockup_html, usage, "No mockup image found, but HTML was extracted"
    ...
    try:
        ...
        with DatabaseConnection() as cursor:
            ...
            cursor.execute(
                """
                INSERT INTO mockups 
                (business_id, mockup_url, mockup_html, usage_data) 
                VALUES (?, ?, ?, ?)
                """,
                (
                    business_id,
...
def generate_business_mockup(
    ...
    # Try GPT-4o first
    mockup_image_base64, mockup_html, usage_data, error = gpt4o_generator.generate_mockup(
    ...
    if (not mockup_image_base64 or not mockup_html) and ANTHROPIC_API_KEY:
        ...
        claude_image, claude_html, claude_usage, claude_error = claude_generator.generate_mockup(
            business_data=business,
            screenshot_url=screenshot_url,
            style=style,
            resolution=resolution
...
def main():
    ...
    parser.add_argument("--force", action="store_true", help="Force regeneration of mockups for businesses that already have them")
    ...
    for business in businesses:
        try:
            success = generate_business_mockup(
                business=business,
                tier=tier
            )
