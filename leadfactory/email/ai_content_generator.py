...
class AIContentGenerator:
    ...
    async def generate_email_improvements(
        ...
        try:
            ...
            return self._get_default_improvements(
                business_data.get('vertical', 'general'),
                score_breakdown
            )
    ...
    async def generate_call_to_action(
        ...
        try:
            ...
            top_improvement = improvements[0] if improvements else "website improvements"
    ...
    def _get_default_improvements(
        ...
        if score_breakdown:
            ...
            if score_breakdown.get('performance_score', 100) < 50:
                prioritized.append("Lightning-fast page loading (currently taking too long)")
