...
# Gauges
DAILY_COST = Gauge(
    'lead_factory_daily_cost',
    'Total cost for the current day in USD',
    ['service']
)

MONTHLY_COST = Gauge(
    'lead_factory_monthly_cost',
