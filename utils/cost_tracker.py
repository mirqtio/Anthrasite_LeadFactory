...
SCALING_GATE_LOCKFILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "logs", "scaling_gate.lock")
SCALING_GATE_HISTORY_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "logs", "scaling_gate_history.json")
...
if __name__ == "__main__":
    ...
    report_parser.add_argument("--period", default="month", choices=["day", "week", "month", "custom"], help="Time period")
