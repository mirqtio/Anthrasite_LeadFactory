...
class TestCostAggregationService(unittest.TestCase):
    ...
    def test_get_daily_financial_data(self):
        ...
        self.mock_financial_tracker.get_daily_summary.assert_called_once_with('2024-01-15')
    ...
    def test_get_daily_financial_data_error_handling(self):
        ...
        self.mock_financial_tracker.get_daily_summary.side_effect = Exception("Database error")
