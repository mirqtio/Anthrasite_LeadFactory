...
class TestPDFQualityReport:
    ...
    def test_quality_report_creation(self):
        ...
        issues = [
            ValidationIssue(
                ValidationCategory.STRUCTURE, ValidationSeverity.ERROR, "Error 1"
            ),
            ValidationIssue(
                ValidationCategory.CONTENT, ValidationSeverity.WARNING, "Warning 1"
            ),
            ValidationIssue(
                ValidationCategory.SECURITY, ValidationSeverity.CRITICAL, "Critical 1"
            ),
        ]
    ...
    def test_get_issues_by_severity(self):
        ...
        issues = [
            ...
            ValidationIssue(
                ValidationCategory.SECURITY, ValidationSeverity.ERROR, "Error 2"
            ),
        ]
...
class TestPDFQualityValidator:
    ...
    def test_validate_empty_pdf(self):
        ...
        assert any(
            issue.severity == ValidationSeverity.CRITICAL for issue in report.issues
        )
    ...
    def test_calculate_quality_score(self):
        ...
        issues = [
            ValidationIssue(
                ValidationCategory.STRUCTURE, ValidationSeverity.CRITICAL, "Critical"
            )
        ]
        score = validator._calculate_quality_score(issues, 1024, 5)
        ...
        issues = [
            ValidationIssue(
                ValidationCategory.STRUCTURE, ValidationSeverity.ERROR, "Error"
            ),
            ValidationIssue(
                ValidationCategory.CONTENT, ValidationSeverity.WARNING, "Warning"
            ),
            ValidationIssue(
                ValidationCategory.OPTIMIZATION, ValidationSeverity.INFO, "Info"
            ),
        ]
        score = validator._calculate_quality_score(issues, 1024, 5)
        assert 50 < score < 90
