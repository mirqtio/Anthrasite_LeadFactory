...
from leadfactory.api.logs_api import LogsAPI, LogEntry, LogSearchFilters, create_logs_app
...
class TestLogsAPI:
    ...
    def test_fetch_logs_cache_miss(self, logs_api, mock_cache, mock_storage):
        ...
        storage_logs = [{'id': 1, 'content': 'storage log', 'business_id': 123,
                        'log_type': 'llm', 'timestamp': datetime.utcnow(),
                        'metadata': {}}]
    ...
    def test_get_available_log_types(self, logs_api, mock_storage):
        ...
        mock_storage.get_available_log_types.return_value = ['llm', 'raw_html', 'enrichment']
