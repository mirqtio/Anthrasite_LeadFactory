...
class TestProfitReportingService(unittest.TestCase):
    ...
    def test_generate_daily_report(self):
        ...
        self.assertAlmostEqual(
            report["profit"]["gross_margin_percent"], 94.67, places=2
        )

        # Verify metrics section
        self.assertIn("metrics", report)
        self.assertAlmostEqual(
            report["metrics"]["average_transaction_value"], 50.0, places=2
        )
        self.assertAlmostEqual(
            report["metrics"]["cost_per_transaction"], 2.67, places=2
        )

        # Verify the service was called correctly
        self.mock_aggregation_service.get_daily_summary.assert_called_once_with(
            "2024-01-15"
        )
    ...
    def test_generate_weekly_report(self):
        ...
        self.mock_aggregation_service.get_daily_summary.side_effect = (
    ...
    def test_generate_monthly_report(self):
        ...
        self.mock_aggregation_service.get_monthly_summary.return_value = (
            mock_monthly_data
        )
