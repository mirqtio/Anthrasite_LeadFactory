...
class TestCLIMain:
    ...
    def test_cli_verbose_flag(self):
        ...
        with patch('leadfactory.cli.main.logging') as mock_logging:
    ...
    def test_command_execution_with_options(self):
        ...
        with patch('leadfactory.cli.commands.dev_commands.test') as mock_test:
            ...
            result = self.runner.invoke(cli, ['--verbose', 'dev', 'test'])
    ...
    def test_cli_as_module(self):
        ...
        with patch('sys.argv', ['leadfactory', '--help']):
            with patch('leadfactory.cli.main.cli') as mock_cli:
