...
# Mock track_api_cost before importing any modules that might use it
mock_track_api_cost = MagicMock(return_value=None)
...
@pytest.fixture
def run_mockup_generation(mock_gpt4o_client, mock_claude_client, mock_cost_tracker, fixture_high_scoring_business):
