    ...
    with patch('bin.dedupe.get_business_by_id') as mock_get_business:
        ...
        with patch('bin.dedupe.merge_businesses') as mock_merge:
            ...
            with patch('bin.dedupe.DatabaseConnection'):
                ...
                # The is_dry_run parameter is passed as the third positional argument, not as a keyword
        ...
        with patch('bin.dedupe.OllamaVerifier') as mock_verifier_class:
            ...
            with patch('bin.dedupe.get_potential_duplicates') as mock_get_pairs:
                ...
                with patch('bin.dedupe.get_business_by_id') as mock_get_business:
                    ...
                    # Create a custom implementation of process_duplicate_pair to check if it's called with processed pairs
                    ...
                    with patch('bin.dedupe.process_duplicate_pair', side_effect=mock_process_pair):
                        ...
                        with patch('sys.argv', ['bin/dedupe.py']):
                            ...
                            assert processed_pair['id'] not in processed_pairs_processed, \
