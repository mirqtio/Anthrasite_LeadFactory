...
def test_triggers_exist(test_db):
    ...
    cursor.execute("INSERT INTO businesses (name, zip, category, source) VALUES ('Test Business', '12345', 'Test', 'test')")
    ...
    assert new_updated_at != updated_at, "updated_at should be different after update"  # Changed from > to != for reliability
