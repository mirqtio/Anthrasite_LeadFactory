                ...
                with patch('bin.dedupe.flag_for_review') as mock_flag_for_review:
                    ...
                    with patch('bin.dedupe.LevenshteinMatcher') as mock_matcher_class:
                        ...
                        with patch('bin.dedupe.OllamaVerifier') as mock_verifier_class:
                            ...
                            assert found_skip_message, f"Expected message about skipping processed pairs, got: {log_messages}"
                            assert not mock_flag_for_review.called, "flag_for_review should not be called for processed pairs"
