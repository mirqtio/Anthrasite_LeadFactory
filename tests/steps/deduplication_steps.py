...
@scenario('../features/deduplication.feature', 'Identify similar businesses with fuzzy matching')
def test_identify_similar_businesses():
    """Test identifying similar businesses with fuzzy matching."""
    pass

@scenario('../features/deduplication.feature', 'Handle businesses with different addresses but same name')
...
def exact_duplicate_businesses(mock_db):
    ...
    businesses = [
        ('Acme Corp', '123 Main St, New York, NY', 'https://acme.com', '555-1234', 'info@acme.com', 0.8),
        ('Acme Corp', '123 Main St, New York, NY', 'https://acme-corp.com', '555-5678', 'contact@acme.com', 0.6)
    ]
...
def similar_businesses(mock_db):
    ...
    businesses = [
        ('Acme Corporation', '123 Main Street, New York, NY', 'https://acme.com', '555-1234', 'info@acme.com', 0.8),
        ('ACME Corp.', '123 Main St, New York, NY', 'https://acme-corp.com', '555-5678', 'contact@acme.com', 0.6),
        ('Acme Inc', '123 Main Street, New York, NY 10001', 'https://acmeinc.com', '555-9012', 'hello@acmeinc.com', 0.7)
    ]
...
def same_name_different_addresses(mock_db):
    ...
    businesses = [
        ('Starbucks Coffee', '123 Main St, New York, NY', 'https://starbucks.com', '555-1234', 'ny@starbucks.com', 0.8),
        ('Starbucks Coffee', '456 Oak Ave, Boston, MA', 'https://starbucks.com', '555-5678', 'boston@starbucks.com', 0.7)
    ]
...
def processed_businesses(mock_db):
    ...
    businesses = [
        ('Processed Corp', '123 Main St, New York, NY', 'https://processed.com', '555-1234', 'info@processed.com', 0.8, 1),
        ('Another Processed', '456 Oak Ave, Boston, MA', 'https://another.com', '555-5678', 'info@another.com', 0.7, 1)
    ]
